...
class GPT2Model(PreTrainedModel):
    ...
    def forward(
        ...
        position_embeds = self.wpe(position_ids.cuda())
...
class GPT2Block(nn.Module):
    ...
    def forward(
        ...
        attn_output = attn_outputs  # output_attn: a, present, (attentions)
...
def find_pruneable_heads_and_indices(
    ...
    Returns:
        `Tuple[, torch.LongTensor]`: A tuple with the remaining heads and their corresponding indices.
    """
